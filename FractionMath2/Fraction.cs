    ...
    public class Fraction
    {
        ...
        *  ****************************************/
        public Fraction ReduceFraction(Fraction f)
        {
            ...
            {
                if (fraction.numerator % x == 0 && fraction.denominator %
                x == 0)
                {
        ...
        public override string ToString()
        {
            ...
            if (numerator > denominator)
            {
                ...
                fString = n.ToString() + " " + numerator.ToString() + "/"
                + denominator.ToString();
            }
            else
            {
                fString = numerator.ToString() + "/" +
                denominator.ToString();
        ...
        private void GreatestCommonDenominator(Fraction f1, Fraction f2,
        out Fraction f4, out Fraction f5)
        {
